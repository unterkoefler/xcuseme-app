...
-   **Application** means the software program provided by the Company
    downloaded by You on any electronic device, named XCuseMe

-   **Company** (referred to as either "the Company", "We", "Us" or
    "Our" in this Agreement) refers to XCuseMe.
...
The following are links to the privacy policies of third party service providers used by the Application:

1. [Google Play Services](https://policies.google.com/privacy)
2. [Firebase](https://firebase.google.com/support/privacy)
...
-   By email: w.unterkoefler+xcuseme@gmail.com
